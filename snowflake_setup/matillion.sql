...
/** As new schemas are added by MATILLION, use this template to update the read role
// Add <DATASOURCE NAME> read access
GRANT SELECT ON ALL TABLES IN SCHEMA MATILLION_DB.<NEW_SCHEMA_NAME>    TO ROLE MATILLION_DB_READ;
GRANT SELECT ON ALL VIEWS IN SCHEMA MATILLION_DB.<NEW_SCHEMA_NAME>     TO ROLE MATILLION_DB_READ;
GRANT SELECT ON FUTURE TABLES IN SCHEMA MATILLION_DB.<NEW_SCHEMA_NAME> TO ROLE MATILLION_DB_READ;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA MATILLION_DB.<NEW_SCHEMA_NAME>  TO ROLE MATILLION_DB_READ;
**/
